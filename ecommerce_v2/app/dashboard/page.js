        ...
        <nav id="header-nav" className="navbar navbar-expand-lg px-3 mb-3">
          <div className="container-fluid">
            <a className="navbar-brand" href="index.html">
              <Image src="/images/main-logo.png" className="logo" alt="" fill />
            </a>
            <button
            ...
            >
              <div className="offcanvas-header px-4 pb-0">
                <a className="navbar-brand" href="index.html">
                  ...
                  <Image src="/images/main-logo.png" className="logo" fill />
            ...
            <div className="col-md-4 col-sm-6">
              <div className="Shipping d-flex">
                ...
                <div className="card-wrap ps-2">
                  ...
                  <Image src="/images/dhl.png" alt="visa"  fill />
                  {/* <img src="/images/shippingcard.png" alt="mastercard" /> */}
                  <Image src="/images/shippingcard.png" alt="mastercard"  fill />
                </div>
              </div>
            </div>
            <div className="col-md-4 col-sm-6">
              <div className="payment-method d-flex">
                ...
                <div className="card-wrap ps-2">
                  ...
                  <Image src="/images/visa.jpg" alt="visa"  fill />

                  {/* <img src="/images/mastercard.jpg" alt="mastercard" /> */}
                  <Image src="/images/mastercard.jpg" alt="mastercard"  fill />

                  {/* <img src="/images/paypal.jpg" alt="paypal" /> */}
                  <Image src="/images/paypal.jpg" alt="paypal" fill  />
